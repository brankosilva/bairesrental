  ...
  <main v-if="rental" class="br-detail">
    <div id="depto-hero" :class="{ 'depto-hero--noimg': !rental.imagen || heroImgError }">
      ...
      <div id="depto-hero-top">
        <NuxtLink :to="localePath('/departamentos')" class="depto-back-btn">{{ t('detail.backToRentals') }}</NuxtLink>
    ...
    <div class="depto-container">
      ...
      <div class="depto-actions">
        ...
        <div class="depto-actions-row">
          <a :href="waHref" target="_blank" rel="noopener" class="btn-secondary-depto btn-wa-secondary">
      ...
      <NuxtLink :to="localePath('/departamentos')" class="depto-back-bottom">{{ t('detail.backToRentals') }}</NuxtLink>
    </div>
  </main>
