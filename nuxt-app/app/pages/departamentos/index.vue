        ...
        <div v-for="r in filtered" :key="r.id" class="br-prop-card">
          ...
          <div class="br-prop-body">
            ...
            <div class="br-prop-actions">
              <NuxtLink :to="localePath(`/departamentos/${r.id}`)" class="br-btn-detalle-primary w-100 mb-2">
